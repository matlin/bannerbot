...
br = Browser()
registerTime = 1397646000 #Wednesday, April 16th, 2014, 7:00 am
...
br.open( "http://go.middlebury.edu/bw" )

print "Current time: " + time.ctime()
print "Registration time: " + time.ctime(registerTime)
print "****Welcome to BannerBot by Matthew Linkous****"
